...
?- husband('Prince Charles of Wales', 'Camilla Duchess of Cornwall'). % False

% 2. Is Philip Duke of Edinburgh the husband of Queen Elizabeth II?
?- husband('Philip Duke of Edinburgh', 'Hm Queen Elizabeth II'). % True

% 3. Who is the husband of Meghan Duchess of Sussex?
?- husband(X, 'Meghan Duchess of Sussex'). % X = 'Prince Harry Duke of Sussex'.
