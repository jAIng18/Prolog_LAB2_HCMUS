...
?- wife('Catherine Duchess of Cambridge', 'Prince William Duke of Cambridge'). % True

% 2. Is Diana Princess of Wales the wife of Prince Charles of Wales?
?- wife('Diana Princess of Wales', 'Prince Charles of Wales'). % False

% 3. Who is the wife of Philip Duke of Edinburgh?
?- wife(X, 'Philip Duke of Edinburgh'). % X = 'Hm Queen Elizabeth II'.
